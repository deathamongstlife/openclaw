import { AllowFromListSchema, DmPolicySchema } from "jarvis/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "jarvis/plugin-sdk/nostr";
import { z } from "zod";
