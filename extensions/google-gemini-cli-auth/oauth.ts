...
import { fetchWithSsrFGuard, isWSL2Sync } from "jarvis/plugin-sdk/google-gemini-cli-auth";

const CLIENT_ID_KEYS = ["JARVIS_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = ["JARVIS_GEMINI_OAUTH_CLIENT_SECRET", "GEMINI_CLI_OAUTH_CLIENT_SECRET"];
