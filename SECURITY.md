...
- **Core CLI and gateway** — [jarvis/jarvis](https://github.com/deathamongstlife/jarvis)
- **macOS desktop app** — [jarvis/jarvis](https://github.com/deathamongstlife/jarvis) (apps/macos)
- **iOS app** — [jarvis/jarvis](https://github.com/deathamongstlife/jarvis) (apps/ios)
- **Android app** — [jarvis/jarvis](https://github.com/deathamongstlife/jarvis) (apps/android)
...
- Exec approvals bind exact command/cwd/env context and, when Jarvis can identify one concrete local script/file operand, that file snapshot too. This is best-effort integrity hardening, not a complete semantic model of every interpreter/runtime loader path.
