...
describe("argv helpers", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      argv: ["node", "jarvis", "status", "--version"],
      expected: false,
    },
    {
      name: "unknown root flag with version",
      argv: ["node", "jarvis", "--unknown", "--version"],
      expected: false,
    },
  ...
  it.each([
    ...
    },
    {
      ...
      argv: ["node", "jarvis", "--profile", "work", "--help"],
      expected: true,
    },
    {
      name: "subcommand --help",
      argv: ["node", "jarvis", "status", "--help"],
      expected: false,
    },
    {
      name: "help before subcommand token",
      argv: ["node", "jarvis", "--help", "status"],
      expected: false,
    },
    {
      name: "help after -- terminator",
      argv: ["node", "jarvis", "nodes", "run", "--", "git", "--help"],
      expected: false,
    },
    {
      name: "unknown root flag before help",
      argv: ["node", "jarvis", "--unknown", "--help"],
      expected: false,
    },
    {
      name: "unknown root flag after help",
      argv: ["node", "jarvis", "--help", "--unknown"],
      expected: false,
    },
  ...
  it("extracts command path while skipping known root option values", () => {
    expect(
      getCommandPathWithRootOptions(
        ["node", "jarvis", "--profile", "work", "--no-color", "config", "validate"],
        2,
      ),
  ...
  it("extracts routed config get positionals with interleaved root options", () => {
    expect(
      getCommandPositionalsWithRootOptions(
        ["node", "jarvis", "config", "get", "--log-level", "debug", "update.channel", "--json"],
        {
  ...
  it("extracts routed config unset positionals with interleaved root options", () => {
    expect(
      getCommandPositionalsWithRootOptions(
        ["node", "jarvis", "config", "unset", "--profile", "work", "update.channel"],
        {
  ...
  it("returns null when routed command sees unknown options", () => {
    expect(
      getCommandPositionalsWithRootOptions(
        ["node", "jarvis", "config", "get", "--mystery", "value", "update.channel"],
        {
          commandPath: ["config", "get"],
          booleanFlags: ["--json"],
        },
  ...
  it.each([
    ...
    },
    {
      ...
      argv: ["node", "jarvis", "--log-level", "debug", "status"],
      expected: "status",
    },
