...
const tmpDirMocks = vi.hoisted(() => ({
  resolvePreferredJarvisTmpDir: vi.fn(() => "/tmp/openclaw"),
}));
...
describe("pw-tools-core", () => {
  beforeEach(() => {
    ...
    tmpDirMocks.resolvePreferredJarvisTmpDir.mockReturnValue("/tmp/openclaw");
  });
  ...
  it("uses preferred tmp dir when waiting for download without explicit path", async () => {
    tmpDirMocks.resolvePreferredJarvisTmpDir.mockReturnValue("/tmp/openclaw-preferred");
