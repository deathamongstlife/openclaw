...
export function hasAmbiguousGatewayAuthModeConfig(cfg: JarvisConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: JarvisConfig): void {
