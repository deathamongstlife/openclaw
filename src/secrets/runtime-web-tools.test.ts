...
async function runRuntimeWebTools(params: { config: JarvisConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: JarvisConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
