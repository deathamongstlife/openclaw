...
export function listAuthProfileStorePaths(config: JarvisConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: JarvisConfig, stateDir: string): string[] {
