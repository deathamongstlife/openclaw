...
export function resolveIdentityNamePrefix(cfg: JarvisConfig, agentId: string): string | undefined {
...
function getChannelConfig(cfg: JarvisConfig, channel: string): Record<string, unknown> | undefined {
