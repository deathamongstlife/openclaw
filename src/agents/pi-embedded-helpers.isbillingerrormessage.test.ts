...
// https://github.com/jarvis/jarvis/issues/23440
...
describe("classifyFailoverReason", () => {
  ...
  it("classifies internal and compatibility error messages", () => {
    ...
    expect(
      classifyFailoverReason(
        'No API key found for provider "openai". Auth store: /tmp/jarvis-agent-abc/auth-profiles.json (agentDir: /tmp/jarvis-agent-abc).',
      ),
    ).toBe("auth");
