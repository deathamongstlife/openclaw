...
function validateGatewayTailscaleBind(config: JarvisConfig): ConfigValidationIssue[] {
...
export function validateConfigObjectRaw(
  ...
  const gatewayTailscaleBindIssues = validateGatewayTailscaleBind(validated.data as JarvisConfig);
