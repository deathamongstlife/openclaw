...
import { JarvisSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: JarvisConfig): {
  config: JarvisConfig;
  removed: string[];
} {
...
export function noteOpencodeProviderOverrides(cfg: JarvisConfig): void {
