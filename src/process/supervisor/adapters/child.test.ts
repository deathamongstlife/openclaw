...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.JARVIS_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.JARVIS_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.JARVIS_SERVICE_MARKER = originalServiceMarker;
    }
  });
