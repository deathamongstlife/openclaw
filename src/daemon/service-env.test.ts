...
describe("buildServiceEnvironment", () => {
  it("sets minimal PATH and gateway vars", () => {
    ...
    expect(env.OPENCLAW_SYSTEMD_UNIT).toBe("jarvis-gateway.service");
    expect(env.OPENCLAW_WINDOWS_TASK_NAME).toBe("Jarvis Gateway");
  ...
  it("uses profile-specific unit and label", () => {
    ...
    expect(env.OPENCLAW_SYSTEMD_UNIT).toBe("jarvis-gateway-work.service");
    expect(env.OPENCLAW_WINDOWS_TASK_NAME).toBe("Jarvis Gateway (work)");
    if (process.platform === "darwin") {
