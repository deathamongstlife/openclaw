...
export type JarvisPluginHttpRouteAuth = "gateway" | "plugin";
export type JarvisPluginHttpRouteMatch = "exact" | "prefix";
...
export type JarvisPluginHttpRouteParams = {
  path: string;
  handler: JarvisPluginHttpRouteHandler;
  auth: JarvisPluginHttpRouteAuth;
  match?: JarvisPluginHttpRouteMatch;
...
export type JarvisPluginApi = {
  ...
  registerHttpRoute: (params: JarvisPluginHttpRouteParams) => void;
