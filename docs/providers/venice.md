...
```bash
jarvis agent --model venice/kimi-k2-5 --message "Hello, are you working?"
```
...
```bash
jarvis models set venice/kimi-k2-5
jarvis models set venice/claude-opus-4-6
```
...
jarvis agent --model venice/kimi-k2-5 --message "Quick health check"

# Use Claude Opus via Venice (anonymized)
jarvis agent --model venice/claude-opus-4-6 --message "Summarize this task"
