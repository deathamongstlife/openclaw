...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/Jarvis-2026.3.9.zip https://raw.githubusercontent.com/jarvis/jarvis/main/appcast.xml
```
