...
`~/.jarvis/jarvis.json` under `tools.web.search.perplexity.apiKey`.
...
`~/.jarvis/.env` (or your service environment). See [Env vars](/help/faq#how-does-jarvis-load-environment-variables).
