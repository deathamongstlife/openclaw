...
TRASH
  ...
  run_wizard_cmd() {
    ...
    set_isolated_jarvis_env "$home_dir"
  ...
  set_isolated_jarvis_env() {
    local home_dir="$1"
    export HOME="$home_dir"
    export JARVIS_HOME="$home_dir"
    export JARVIS_STATE_DIR="$home_dir/.jarvis"
  ...
  run_case_local_basic() {
    ...
    workspace_dir="$JARVIS_STATE_DIR/workspace"
    config_path="$JARVIS_CONFIG_PATH"
    sessions_dir="$JARVIS_STATE_DIR/agents/main/sessions"
