...
const includeGatewaySuite = process.env.JARVIS_TEST_INCLUDE_GATEWAY === "1";
const includeExtensionsSuite = process.env.JARVIS_TEST_INCLUDE_EXTENSIONS === "1";
...
const silentArgs = process.env.JARVIS_TEST_SHOW_PASSED_LOGS === "1" ? [] : ["--silent=passed-only"];
