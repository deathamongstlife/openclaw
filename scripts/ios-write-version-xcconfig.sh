...
- JARVIS_GATEWAY_VERSION = exact package.json version
- JARVIS_MARKETING_VERSION = short iOS/App Store version
- JARVIS_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
JARVIS_GATEWAY_VERSION = ${PACKAGE_VERSION}
JARVIS_MARKETING_VERSION = ${MARKETING_VERSION}
JARVIS_BUILD_VERSION = ${BUILD_NUMBER}
EOF
