...
public struct JarvisChatView: View {
    ...
    private func shouldDisplayMessage(_ message: JarvisChatMessage) -> Bool {
    ...
    private func primaryText(in message: JarvisChatMessage) -> String {
    ...
    private func hasInlineAttachments(in message: JarvisChatMessage) -> Bool {
    ...
    private func toolCalls(in message: JarvisChatMessage) -> [JarvisChatMessageContent] {
    ...
    private func inlineToolResults(in message: JarvisChatMessage) -> [JarvisChatMessageContent] {
        message.content.filter { content in
            let kind = (content.type ?? "").lowercased()
