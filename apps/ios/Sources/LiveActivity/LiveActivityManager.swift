...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.jarvis.ios", category: "LiveActivity")
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = JarvisActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<JarvisActivityAttributes>.activities
    ...
    private func updateCurrent(state: JarvisActivityAttributes.ContentState) {
    ...
    private func connectingState() -> JarvisActivityAttributes.ContentState {
        JarvisActivityAttributes.ContentState(
    ...
    private func idleState() -> JarvisActivityAttributes.ContentState {
        JarvisActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> JarvisActivityAttributes.ContentState {
        JarvisActivityAttributes.ContentState(
