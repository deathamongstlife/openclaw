...
struct SettingsTab: View {
            ...
            Form {
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Jarvis agent and send /pair\n"
                ...
                Section("Device") {
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Jarvis", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Jarvis chat and run /pair approve, then tap Connect again."
        }
