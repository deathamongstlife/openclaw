...
enum class JarvisSystemCommand(val rawValue: String) {
...
enum class JarvisPhotosCommand(val rawValue: String) {
...
enum class JarvisContactsCommand(val rawValue: String) {
...
enum class JarvisCalendarCommand(val rawValue: String) {
...
enum class JarvisMotionCommand(val rawValue: String) {
