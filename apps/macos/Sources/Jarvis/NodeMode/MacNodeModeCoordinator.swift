...
final class MacNodeModeCoordinator {
    ...
    private func run() async {
        ...
        while !Task.isCancelled {
            ...
            let browserControlEnabled = JarvisConfigFile.browserControlEnabled()
    ...
    private func currentCaps() -> [String] {
        ...
        if JarvisConfigFile.browserControlEnabled() {
            caps.append(JarvisCapability.browser.rawValue)
        }
    ...
    private func currentCommands(caps: [String]) -> [String] {
        ...
        if capsSet.contains(JarvisCapability.browser.rawValue) {
            commands.append(JarvisBrowserCommand.proxy.rawValue)
        }
