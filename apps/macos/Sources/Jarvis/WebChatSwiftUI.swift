...
private let webChatThinkingLevelDefaultsKey = "jarvis.webchat.thinkingLevel"
...
struct MacGatewayChatTransport: JarvisChatTransport {
    ...
    private static func mapModelChoice(_ model: JarvisProtocol.ModelChoice) -> JarvisChatModelChoice {
        JarvisChatModelChoice(
            modelID: model.id,
            name: model.name,
